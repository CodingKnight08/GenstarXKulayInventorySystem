        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBilling = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashIn = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalSalesToday = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    BeginningBalance = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    InvoiceCash = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    InvoiceChecks = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NonInvoiceCash = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NonInvoiceChecks = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalCash = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalChecks = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalSales = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ChargeSales = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CollectionCash = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CollectionChecks = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Transportation = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Foods = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    SalaryAndAdvances = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Commissions = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Supplies = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    TotalCashOnHand = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfSales = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NameOfClient = table.Column<string>(type: "text", nullable: false),
                    SalesNumber = table.Column<string>(type: "text", nullable: false),
                    RecieptReference = table.Column<string>(type: "text", nullable: false),
                    Branch = table.Column<int>(type: "integer", nullable: false),
                    PaymentType = table.Column<int>(type: "integer", nullable: true),
                    SalesOption = table.Column<int>(type: "integer", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    PaymentTermsOption = table.Column<int>(type: "integer", nullable: true),
                    CustomPaymentTermsOption = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Branch = table.Column<int>(type: "integer", nullable: false),
                    ProductMesurementOption = table.Column<int>(type: "integer", nullable: true),
                    ...
                    BufferStocks = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseShipToOption = table.Column<int>(type: "integer", nullable: false),
                    PurchaseRecieptOption = table.Column<int>(type: "integer", nullable: false),
                    Remarks = table.Column<string>(type: "text", nullable: true),
                    ...
                    PurchaseRecieveOption = table.Column<int>(type: "integer", nullable: false),
                    AssumeTotalAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DailySaleId = table.Column<int>(type: "integer", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    ItemName = table.Column<string>(type: "text", nullable: false),
                    Size = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    BranchPurchased = table.Column<int>(type: "integer", nullable: false),
                    UnitMeasurement = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    ItemPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ProductPricingOption = table.Column<int>(type: "integer", nullable: false),
                    PaintCategory = table.Column<int>(type: "integer", nullable: false),
                    DataList = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseOrderBillingNumber = table.Column<string>(type: "text", nullable: false),
                    PurchaseOrderBillingDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExpectedPaymentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Remarks = table.Column<string>(type: "text", nullable: true),
                    AmountToBePaid = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    AmountPaid = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    IsPaid = table.Column<bool>(type: "boolean", nullable: false),
                    BillingBranch = table.Column<int>(type: "integer", nullable: false),
                    PaymentMethod = table.Column<int>(type: "integer", nullable: false),
                    IsDiscounted = table.Column<bool>(type: "boolean", nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    PaymentTermsOption = table.Column<int>(type: "integer", nullable: false),
                    CustomPaymentTermsOption = table.Column<int>(type: "integer", nullable: true),
                    ItemsRecieved = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PurchaseItemMeasurementOption = table.Column<int>(type: "integer", nullable: true),
