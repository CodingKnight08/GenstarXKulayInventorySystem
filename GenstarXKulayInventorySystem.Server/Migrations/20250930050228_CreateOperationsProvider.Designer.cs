...
namespace GenstarXKulayInventorySystem.Server.Migrations
{
    ...
    [Migration("20250930050228_CreateOperationsProvider")]
    partial class CreateOperationsProvider
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenstarXKulayInventorySystem.Server.Model.Billing", b =>
                {
                    ...
                    b.Property<int?>("OpertationsProviderId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OpertationsProviderId");
            ...
            modelBuilder.Entity("GenstarXKulayInventorySystem.Server.Model.Billing", b =>
                {
                    ...
                    b.HasOne("GenstarXKulayInventorySystem.Server.Model.OperationsProvider", "OperationsProvider")
                        .WithMany("Billings")
                        .HasForeignKey("OpertationsProviderId")
                        .OnDelete(DeleteBehavior.SetNull);
