        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSalesToday = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BeginningBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InvoiceCash = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InvoiceChecks = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NonInvoiceCash = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NonInvoiceChecks = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    CollectionCash = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CollectionChecks = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Transportation = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Foods = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SalaryAndAdvances = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Commissions = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Supplies = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    TotalCashOnHand = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DailySaleReportId = table.Column<int>(type: "int", nullable: true),
                    ...
                    PaymentTermsOption = table.Column<int>(type: "int", nullable: true),
                    CustomPaymentTermsOption = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OperationsProviderId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.OperationsProviderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Branch = table.Column<int>(type: "int", nullable: false),
                    ProductMesurementOption = table.Column<int>(type: "int", nullable: true),
                    ...
                    BufferStocks = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseShipToOption = table.Column<int>(type: "int", nullable: false),
                    PurchaseRecieptOption = table.Column<int>(type: "int", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PurchaseRecieveOption = table.Column<int>(type: "int", nullable: false),
                    AssumeTotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
